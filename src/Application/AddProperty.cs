        ...
        if (Regex.IsMatch(postalCode, @"^\d{5}$"))
        {
            if (price >= 0)
            {
                ...
                if (user != null)
                {
                    ...
                    var allProperties = JsonConvert.DeserializeObject<List<Property>>(propertiesAsString) ??
                                        new List<Property>();
                    ...
                    foreach (var alert in alerts)
                    {
                        if (HasToSendTheAlert(property, alert))
                        {
                            ...
                            if (userToAlert != null)
                            {
                                if (alert.AlertType.Equals(AlertType.EMAIL.ToString(),
                                ...
                                else if (alert.AlertType.Equals(AlertType.SMS.ToString(),
                                             StringComparison.OrdinalIgnoreCase))
                                {
                                ...
                                else if (alert.AlertType.Equals(AlertType.PUSH.ToString(),
                                             StringComparison.OrdinalIgnoreCase))
                                {
